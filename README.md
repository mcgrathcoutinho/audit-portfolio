...
Currently, I am a warden on [Code4rena](https://code4rena.com/), where I've disclosed 27 High-severity and 26 Medium-severity issues spanning Staking, Lending (CDP), Cross-chain, Governance, Liquid Staking Derivative (LSD) and many more protocol types.
