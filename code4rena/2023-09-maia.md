...
| [L-05](#l-05-leave-some-degree-of-configurability-for-extra-parameters-in-_adapterparams-to-allow-for-feature-extensions) | Leave some degree of configurability for extra parameters in `_adapterParams` to allow for feature extensions                                                                  | 2            |
| [L-06](#l-06-do-not-hardcode-layerzeros-proprietary-chainids) | Do not hardcode LayerZero's proprietary chainIds                                                                                                                               |              |
| [L-07](#l-07-array-entry-not-deleted-when-removing-bridge-agent) | Array entry not deleted when removing bridge agent                                                                                                                             |              |
| [L-08](#l-08-double-entries-in-strategytokens-portstrategies-and-bridgeagents-arrays-are-not-prevented) | Double entries in `strategyTokens`, `portStrategies`, `bridgeAgents` and `bridgeAgentFactories` arrays are not prevented                                                       |              |
...
| [N-05](#n-05-no-need-to-limit-settlementnonce-input-to-uint32) | No need to limit `settlementNonce` input to uint32                                                                                                                             |              |
| [N-06](#n-06-setting-depositowner--address0-is-not-required) | Setting `deposit.owner = address(0);` is not required                                                                                                                          |              |
